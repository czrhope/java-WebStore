			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div
						...
						<form action="${pageContext.request.contextPath }/transaction?method=addToCart" method="post">
							<div
								style="border-bottom: 1px solid #faeac7; margin-top: 20px; padding-left: 10px;">
								购买数量: <input id="quantity" name="orderNum" value="1"
							...
							<input type="hidden" name="shop_price" value="${product.shop_price }">
