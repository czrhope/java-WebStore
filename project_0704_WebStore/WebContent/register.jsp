	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="registerForm" class="form-horizontal" style="margin-top: 5px;" action="${pageContext.request.contextPath }/user?method=register" method="post">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							...
							<label for="sex" class="error" generated="true"></label>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							...
							<span id="checkImg_info" style="color:red">${register_info }</span>
						</div>
